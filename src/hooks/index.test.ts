...
const EXPECTED = [
    ...
    "useQueryExamProgramsSwr",
    "useQueryPapersSwr",
    "useQueryPaperDetailSwr",
    "useMutateGradePaperSwr",
    "useMutatePurchaseMembershipSwr",
    "useQueryProgressSummarySwr",
    "useQueryWrappedSwr",
    "useQueryLearnTopicsSwr",
    "useQueryTopicDetailSwr",
    "useQueryPhrasePracticeSwr",
    "useQueryContinueLearningSwr",
]
