...
vi.mock("./component", () => ({ _CodingProblemPage: ({ on }: CodingProps) => <><output data-testid="state">rendered</output><button onClick={on.submit}>submit</button><button onClick={on.verdictAct}>retry</button></> }))
