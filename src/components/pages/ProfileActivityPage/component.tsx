...
const Activity = ({ feed }: Pick<ProfileActivityPageProps, "feed">) => <SurfaceCard props={{ label: "Activity", isFrameless: true }} contract="activity-feed-result" render={defineContractProjection("activity-feed-result", () => <ActivityFeedBase {...feed} />)} />
