...
describe("ProfileActivityPageBase", () => {
    it("keeps earned achievements before day-grouped activity", () => {
        ...
        expect(container.querySelector(".layout-name-profile-achievement-grid")).toBeInTheDocument()
        expect(container.querySelector(".layout-name-activity-day-group")).toBeInTheDocument()
