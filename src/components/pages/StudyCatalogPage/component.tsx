...
export const StudyCatalogPageBase = ({ surface: Surface }: StudyCatalogPageProps) => <Tree contract="routed-page-main" render={defineContractComponent("routed-page-main", { page: defineLeafComponent("page", {}, () => <Surface />) })} />
