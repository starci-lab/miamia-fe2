...
const COPY = {
    en: {
        ...
        companies: "Companies", consultants: "Consultants", open: "Open company", contact: "Contact",
    ...
    vi: {
        title: "Đối tác tuyển dụng", course: "Khóa học", search: "Tìm công ty", clear: "Xóa tìm kiếm công ty", // vn-ok: Vietnamese runtime copy while shared message catalogs are frozen.
        companies: "Công ty", consultants: "Chuyên viên tư vấn", open: "Mở công ty", contact: "Liên hệ", // vn-ok: Vietnamese runtime copy while shared message catalogs are frozen.
        locked: (score: number) => `Cần điểm CV ${score}`, empty: "Không có công ty tuyển dụng phù hợp.", // vn-ok: Vietnamese runtime copy while shared message catalogs are frozen.
        failed: "Không tải được danh sách đối tác tuyển dụng.", retry: "Thử lại", // vn-ok: Vietnamese runtime copy while shared message catalogs are frozen.
    },
} as const
    ...
    return (
        <CourseHeadhuntingsPageBase
            ...
            props={{
                ...
                companiesLabel: copy.companies,
                consultantsLabel: copy.consultants,
                companies: visible.map((company) => ({
                    id: company.id,
                    label: company.title,
                    meta: company.description ?? undefined,
                })),
