...
describe("PublicProfileLayoutBase", () => {
    it("owns profile tabs above the identity-and-evidence body", () => {
        ...
        const profileChrome = container.querySelector(".layout-name-profile-tabs-over-body")
        expect(profileChrome).toBeTruthy()
        expect(profileChrome?.querySelector(".layout-name-underlined-tab-strip")).toBeTruthy()
    ...
    it("keeps the same chrome while the profile is still loading", () => {
        ...
        expect(container.querySelector(".layout-name-profile-tabs-over-body")).toBeTruthy()
