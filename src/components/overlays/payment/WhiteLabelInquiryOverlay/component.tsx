...
export const _WhiteLabelInquiryOverlay = ({ isOpen, panel: Panel, onDismiss }: WhiteLabelInquiryOverlayProps) => <ModalBranch isOpen={isOpen} size="sm" onDismiss={onDismiss}><Panel /></ModalBranch>
