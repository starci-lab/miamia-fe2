...
import { _ComingSoonOverlay } from "./component"
...
export const ComingSoonOverlay = (input: ComingSoonOverlayConnectedProps) => {
    ...
    return <_ComingSoonOverlay isOpen={input.isOpen} title={t("title", { feature: input.featureLabel })} body={t("body")} closeLabel={t("close")} onDismiss={input.onDismiss} />
}
