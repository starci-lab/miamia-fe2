...
describe("ChangelogListBase", () => {
    it("renders joined semantic rows with full-width separators", () => {
        ...
        const list = container.querySelector(".layout-name-changelog-list")
        ...
        expect(list?.querySelectorAll(":scope > .layout-name-changelog-entry-row")).toHaveLength(1)
    })
    ...
    it("keeps four joined resting rows", () => {
        ...
        expect(container.querySelectorAll(".layout-name-changelog-entry-row")).toHaveLength(4)
    })
