...
describe("WeeklyChallengeCardBase", () => {
    it("draws challenge facts, viewer outcome and recent finishers as distinct rows", () => {
        ...
        expect(container.querySelector(".layout-name-weekly-challenge-card")).toBeInTheDocument()
        expect(container.querySelector(".layout-name-weekly-challenge-finishers")).toBeInTheDocument()
        ...
        expect(container.querySelector(".layout-name-weekly-challenge-finishers")?.className).not.toMatch(/rounded|border/)
        expect(container.querySelectorAll(".layout-name-weekly-challenge-finisher-row")).toHaveLength(2)
    ...
    it("rests with the same header, status and three-finisher cardinality", () => {
        ...
        expect(container.querySelectorAll(".layout-name-weekly-challenge-finisher-row")).toHaveLength(3)
        expect(container.querySelectorAll("[data-component=\"StatRow\"]")).toHaveLength(0)
