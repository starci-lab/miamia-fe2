 ...
 *
 * WHAT IT DOES OWN is the seam between them, which is a layout, and the name over them, which is
 * copy. Nothing else.
 *
...
export const IdentityRail = () => {
    return (
        <Grammar
            layout="profile-over-stat-rows"
            render={layoutNode("profile-over-stat-rows", {
                profile: renderComposite("profile-row", {}, () => <ProfileIdentityRow />),
                stats: layoutNode("stacked-stat-rows", {
                    stat: [
                        renderComposite("stat-row", {}, () => <StreakStatRow />),
                        renderComposite("stat-row", {}, () => <CreditStatRow />),
                        renderComposite("stat-row", {}, () => <RewardStatRow />),
                    ],
                }),
            })}
        />
