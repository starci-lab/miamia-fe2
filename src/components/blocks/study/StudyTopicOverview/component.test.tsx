...
describe("StudyTopicOverviewBase", () => { it("renders response-backed phrases", () => { render(<StudyTopicOverviewBase state="ready" props={props} />); expect(screen.getByText("check in")).toBeTruthy(); expect(screen.getByText("làm thủ tục")).toBeTruthy() }) })
