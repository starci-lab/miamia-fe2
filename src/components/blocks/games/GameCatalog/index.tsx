import { GAME_CATALOG } from "@/modules/games/catalog"; import type { GameId } from "@/modules/games/types"; import { _GameCatalog } from "./component"
...
export const GameCatalog = ({ onPickGame }: GameCatalogProps) => <_GameCatalog state="ready" props={{ title: "Chọn một trò để bắt đầu", games: GAME_CATALOG, actionLabel: "Thiết lập ván" }} on={{ pick: onPickGame }} />
