 ...
 *
 * The underline variant keeps the vendor indicator. It marks a filter inside one list rather than
 * naming which panel is on screen, and leaving it alone keeps one implementation of it rather than
